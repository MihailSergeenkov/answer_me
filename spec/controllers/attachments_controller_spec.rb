...
RSpec.describe AttachmentsController, type: :controller do
  ...
  describe 'DELETE #destroy' do
    ...
    let!(:another_question_attachment) { create(:question_attachment, attachable: another_question) }
    let!(:answer_attachment) { create(:answer_attachment, attachable: question) }
    let!(:another_answer_attachment) { create(:answer_attachment, attachable: another_question) }
