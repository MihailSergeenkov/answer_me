...
RSpec.describe CommentsController, type: :controller do
  ...
  describe 'POST #create' do
    ...
    context 'question' do
      ...
      it 'the new comment to question with invalid body does not save in the database' do
    ...
    context 'answer' do
      it 'saves the new comment to answer in the database' do
      ...
      it 'the new comment to answer with invalid body does not save in the database' do
